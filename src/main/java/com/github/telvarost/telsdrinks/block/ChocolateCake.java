...
public class ChocolateCake extends TemplateCakeBlock {
    public ChocolateCake(Identifier identifier, int texture) {
    ...
    public int getTexture(int side, int meta) {
        if (side == 1) {
            return TelsDrinks.CHOCOLATE_CAKE_TOP_TEXTURE;
        } else if (side == 0) {
            return this.textureId + 3;
        } else {
            return meta > 0 && side == 4 ? TelsDrinks.CHOCOLATE_CAKE_INSIDE_TEXTURE : TelsDrinks.CHOCOLATE_CAKE_SIDE_TEXTURE;
        }
    }
    ...
    public int getTexture(int side) {
        if (side == 1) {
            ...
            return side == 0 ? this.textureId + 3 : TelsDrinks.CHOCOLATE_CAKE_SIDE_TEXTURE;
        }
    }
